...
(lib.BGtitle = function() {
	this.initialize(img.BGtitle);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1768,923);
...
(lib.BGtitle_1 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.moveTo(-297.4,49).lineTo(-297.4,-49).lineTo(255.2,-49).curveTo(272.7,-49,285.1,-34.6).curveTo(297.4,-20.3,297.4,0).curveTo(297.4,20.3,285.1,34.7).curveTo(272.7,49,255.2,49).closePath();
	mask.setTransform(297.4,49);
...
}).prototype = getMCSymbolPrototype(lib.BGtitle_1, new cjs.Rectangle(0,0,594.8,98), null);
...
(lib.title = function(mode,startPosition,loop) {
	...
	// 重点：下弹力跳音
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#000000").beginStroke().moveTo(-17.2,26.1).lineTo(-17.2,1.3).lineTo(17.8,1.3).lineTo(17.8,26).lineTo(13.5,26).lineTo(13.5,24).lineTo(-13.1,24).lineTo(-13.1,26.1).closePath().moveTo(-13.1,20.4).lineTo(13.5,20.4).lineTo(13.5,14.2).lineTo(-13.1,14.2).closePath().moveTo(-13.1,10.9).lineTo(13.5,10.9).lineTo(13.5,4.9).lineTo(-13.1,4.9).closePath().moveTo(-25.1,-3.5).lineTo(-25.1,-7.3).lineTo(-10.9,-7.3).curveTo(-11.3,-9.2,-12.2,-11.4).curveTo(-13.1,-13.6,-14.2,-15.4).lineTo(-10.2,-16.4).curveTo(-8.9,-14.3,-7.9,-12).curveTo(-6.8,-9.7,-6.5,-7.8).lineTo(-8.3,-7.3).lineTo(6.4,-7.3).lineTo(7.8,-10.3).lineTo(9.2,-13.6).lineTo(10.3,-16.6).lineTo(14.9,-15.5).lineTo(12.8,-11.3).lineTo(10.9,-7.3).lineTo(25.1,-7.3).lineTo(25.1,-3.5).closePath().moveTo(-21.8,-16.8).lineTo(-21.8,-20.5).lineTo(-1.5,-20.5).lineTo(-2.5,-23).lineTo(-3.6,-25.3).lineTo(0.4,-26.1).curveTo(1.3,-24.9,2.1,-23.4).curveTo(2.8,-21.9,3.2,-20.5).lineTo(22.3,-20.5).lineTo(22.3,-16.8).closePath();
	this.shape.setTransform(503,49.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#000000").beginStroke().moveTo(-7,24.4).curveTo(-7.7,23.4,-8.4,22.8).curveTo(-4.7,21,-2.5,18.3).curveTo(-0.3,15.6,0.7,12.4).curveTo(1.8,9.2,2.1,5.8).lineTo(-1.9,8.9).lineTo(-5.7,11.9).lineTo(-8.1,8.1).lineTo(-3.3,5.1).lineTo(2.4,1.5).lineTo(2.5,-0.4).lineTo(2.5,-2.2).lineTo(2.5,-25.9).lineTo(6.3,-25.9).lineTo(6.3,-2.2).curveTo(6.3,1.6,6,5.6).curveTo(5.6,9.6,4.4,13.3).curveTo(3.2,17.2,0.8,20.3).curveTo(-1.6,23.6,-5.7,25.9).lineTo(-7,24.4).closePath().moveTo(13.2,24.4).curveTo(12.1,23.8,11.6,22.4).curveTo(11.2,21.1,11.2,18.6).lineTo(11.2,-25.9).lineTo(15.2,-25.9).lineTo(15.2,0.2).lineTo(16,-0.5).lineTo(19.7,2.3).curveTo(21.7,3.9,23.3,5.6).curveTo(25,7.1,26.2,8.4).lineTo(23.4,11.3).curveTo(22,9.6,19.8,7.6).curveTo(17.6,5.4,15.2,3.4).lineTo(15.2,18.6).curveTo(15.2,20.1,15.4,20.6).curveTo(15.7,21.1,16.6,21.1).lineTo(21.2,21.1).curveTo(21.8,21.1,22.1,20.5).curveTo(22.3,20,22.4,18.5).lineTo(22.7,14.6).lineTo(24.3,15.6).curveTo(25.4,16.1,26.2,16.3).curveTo(26,21,25,22.9).curveTo(23.9,24.9,21.5,24.9).lineTo(16.2,24.9).lineTo(15.8,24.9).curveTo(14.1,24.9,13.2,24.4).closePath().moveTo(-26.2,18.4).lineTo(-23.3,17.7).lineTo(-23.3,-1.4).lineTo(-20,-1.4).lineTo(-20,16.9).lineTo(-16.4,16).lineTo(-16.4,-5.9).lineTo(-23.4,-5.9).lineTo(-23.4,-23).lineTo(-7.1,-23).lineTo(-7.1,-5.9).lineTo(-12.9,-5.9).lineTo(-12.9,1.3).lineTo(-6.9,1.3).lineTo(-6.9,5).lineTo(-12.9,5).lineTo(-12.9,15.2).lineTo(-6,13.4).lineTo(-5.5,16.9).lineTo(-16,19.8).lineTo(-25.3,22.2).closePath().moveTo(-19.8,-9.5).lineTo(-10.7,-9.5).lineTo(-10.7,-19.4).lineTo(-19.8,-19.4).closePath().moveTo(15.2,-6.2).lineTo(17.4,-10.1).lineTo(19.6,-14.6).curveTo(20.7,-16.8,21.5,-18.8).lineTo(25.3,-16.9).lineTo(23,-12.6).lineTo(20.6,-8.3).curveTo(19.4,-6.2,18.2,-4.6).closePath().moveTo(-2.4,-8.6).curveTo(-3.1,-10.8,-4.1,-12.9).curveTo(-5.2,-15.1,-6.3,-17).lineTo(-3,-18.5).curveTo(-1.8,-16.6,-0.8,-14.5).curveTo(0.3,-12.3,1,-10.3).curveTo(1.8,-8.1,2.2,-6.5).lineTo(-1.3,-4.8).curveTo(-1.6,-6.6,-2.4,-8.6).closePath();
	this.shape_1.setTransform(446.5,49.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#000000").beginStroke().moveTo(-22.3,24.1).curveTo(-23.2,23.2,-24,22.6).curveTo(-18.2,19.2,-14.5,15.2).curveTo(-10.8,11.3,-8.7,7.1).curveTo(-6.5,2.9,-5.4,-1.3).curveTo(-4.5,-5.6,-4.2,-9.5).lineTo(-22.3,-9.5).lineTo(-22.3,-13.7).lineTo(-3.9,-13.7).lineTo(-3.9,-15).lineTo(-3.9,-16.1).lineTo(-3.9,-25.9).lineTo(0.4,-25.9).lineTo(0.4,-16.1).lineTo(0.4,-15).lineTo(0.4,-13.7).lineTo(24,-13.7).lineTo(23.9,-13.2).lineTo(23.9,-12.3).lineTo(23.8,-11.5).curveTo(23.4,-2.8,22.9,3.3).curveTo(22.5,9.4,21.9,13.4).curveTo(21.3,17.4,20.6,19.6).curveTo(19.8,21.9,19,23).curveTo(18,24.2,16.8,24.7).curveTo(15.7,25.1,14.1,25.3).curveTo(12.6,25.4,10.1,25.3).lineTo(5,25.1).curveTo(5,24.1,4.7,22.9).curveTo(4.3,21.7,3.7,20.8).curveTo(6.6,21,9.1,21.1).lineTo(12.6,21.2).curveTo(13.4,21.2,14,21).curveTo(14.6,20.8,15.2,20.3).curveTo(16.1,19.4,17,16.2).curveTo(17.8,12.9,18.3,6.7).curveTo(19,0.4,19.5,-9.5).lineTo(0.2,-9.5).curveTo(-0,-5.1,-1.1,-0.5).curveTo(-2.2,4.3,-4.4,8.8).curveTo(-6.7,13.5,-10.6,17.8).curveTo(-14.7,22.2,-20.7,25.9).curveTo(-21.3,25.1,-22.3,24.1).closePath();
	this.shape_2.setTransform(388.6,49.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#000000").beginStroke().moveTo(6.5,25.8).lineTo(6.5,15.4).lineTo(-8.7,15.4).lineTo(-8.7,11.5).lineTo(6.5,11.5).lineTo(6.5,6.9).lineTo(-5.4,6.9).lineTo(-5.4,-14).lineTo(10.4,-14).lineTo(12.7,-17.7).lineTo(14.8,-21.9).curveTo(15.9,-23.9,16.6,-25.8).lineTo(20.8,-24.5).lineTo(17.9,-19).lineTo(14.7,-14).lineTo(22.9,-14).lineTo(22.9,6.9).lineTo(10.7,6.9).lineTo(10.7,11.5).lineTo(25.4,11.5).lineTo(25.4,15.4).lineTo(10.7,15.4).lineTo(10.7,25.8).closePath().moveTo(10.7,3.5).lineTo(18.9,3.5).lineTo(18.9,-2).lineTo(10.7,-2).closePath().moveTo(-1.6,3.5).lineTo(6.5,3.5).lineTo(6.5,-2).lineTo(-1.6,-2).closePath().moveTo(10.7,-5.2).lineTo(18.9,-5.2).lineTo(18.9,-10.5).lineTo(10.7,-10.5).closePath().moveTo(-1.6,-5.2).lineTo(6.5,-5.2).lineTo(6.5,-10.5).lineTo(-1.6,-10.5).closePath().moveTo(-22.9,25.5).curveTo(-23,24.4,-23.4,23.3).curveTo(-23.7,22.3,-24.3,21.3).lineTo(-20.4,21.6).lineTo(-17.7,21.7).lineTo(-16.6,21.5).curveTo(-16.2,21.4,-15.7,21.1).curveTo(-15.2,20.6,-14.9,18.8).curveTo(-14.5,17.1,-14.2,14).lineTo(-13.6,5.6).lineTo(-25.1,5.6).lineTo(-24.8,0.5).lineTo(-24.6,-5.2).lineTo(-24.5,-10.9).lineTo(-13.6,-10.9).lineTo(-13.6,-19.5).lineTo(-25.4,-19.5).lineTo(-25.4,-23.3).lineTo(-9.6,-23.3).lineTo(-9.6,-7).lineTo(-20.9,-7).lineTo(-21,-2.5).lineTo(-21.2,1.9).lineTo(-9.5,1.9).lineTo(-9.5,2.5).lineTo(-9.6,3.7).curveTo(-9.9,10.4,-10.3,14.5).curveTo(-10.7,18.5,-11.2,20.8).curveTo(-11.7,23,-12.5,23.8).curveTo(-13.2,24.7,-14,25).curveTo(-14.9,25.4,-16.1,25.5).lineTo(-19,25.6).lineTo(-22.9,25.5).closePath().moveTo(1,-17.8).lineTo(-0.9,-21).lineTo(-3,-24).lineTo(0.4,-25.5).curveTo(2.1,-23.4,3.6,-21).curveTo(5.1,-18.6,5.9,-16.7).lineTo(2.5,-14.9).curveTo(1.9,-16.2,1,-17.8).closePath();
	this.shape_3.setTransform(333.6,49.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#000000").beginStroke().moveTo(-3.4,23.6).lineTo(-3.4,-19.3).lineTo(-25,-19.3).lineTo(-25,-23.6).lineTo(25,-23.6).lineTo(25,-19.3).lineTo(1.1,-19.3).lineTo(1.1,-9.4).lineTo(1.8,-10.2).curveTo(5.2,-8.6,9,-6.5).lineTo(16.2,-2.2).curveTo(19.7,-0.1,22,1.7).lineTo(19,5.5).curveTo(17.1,3.9,14.1,1.9).curveTo(11.1,-0,7.8,-2.1).lineTo(1.1,-6).lineTo(1.1,23.6).closePath();
	this.shape_4.setTransform(276.5,51.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#000000").beginStroke().moveTo(-3,17).curveTo(-4.2,15.8,-4.2,13.9).curveTo(-4.2,11.9,-3,10.8).curveTo(-1.8,9.7,-0.1,9.7).curveTo(1.8,9.7,3,10.8).curveTo(4.2,11.9,4.2,13.9).curveTo(4.2,15.8,3,17).curveTo(1.8,18.1,-0.1,18.1).curveTo(-1.8,18.1,-3,17).closePath().moveTo(-3,-10.8).curveTo(-4.2,-11.9,-4.2,-13.8).curveTo(-4.2,-15.8,-3,-17).curveTo(-1.8,-18.1,-0.1,-18.1).curveTo(1.8,-18.1,3,-17).curveTo(4.2,-15.8,4.2,-13.8).curveTo(4.2,-11.9,3,-10.8).curveTo(1.8,-9.6,-0.1,-9.6).curveTo(-1.8,-9.6,-3,-10.8).closePath();
	this.shape_5.setTransform(205.7,53.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#000000").beginStroke().moveTo(-25.5,23.9).curveTo(-24,22.7,-22.6,20.9).curveTo(-21.2,19,-20,16.9).curveTo(-18.8,14.8,-17.8,12.7).lineTo(-13.9,13.7).curveTo(-15.3,17.1,-17.3,20.4).curveTo(-19.4,23.5,-21.7,25.8).closePath().moveTo(19.8,21.8).curveTo(18.6,19.8,17.2,17.7).curveTo(15.8,15.6,14.3,13.8).lineTo(18,12.3).lineTo(21,16.2).lineTo(23.6,20.2).curveTo(24.8,22.2,25.5,23.8).lineTo(21.6,25.4).curveTo(20.9,23.8,19.8,21.8).closePath().moveTo(-7.7,22.1).lineTo(-8.1,18.1).lineTo(-8.8,14.2).lineTo(-4.7,13.9).lineTo(-4.1,17.7).lineTo(-3.5,21.6).lineTo(-3.3,24.8).lineTo(-7.5,25.4).lineTo(-7.7,22.1).closePath().moveTo(5.9,21.9).curveTo(5.3,20.1,4.5,18).lineTo(2.8,14.3).lineTo(6.6,13.4).curveTo(7.5,15.2,8.4,17.1).curveTo(9.2,19.1,9.9,21).curveTo(10.5,22.8,10.9,24.2).lineTo(6.8,25.2).curveTo(6.5,23.8,5.9,21.9).closePath().moveTo(-18.6,9.3).lineTo(-18.6,-8.6).lineTo(-2.3,-8.6).lineTo(-2.3,-25.8).lineTo(1.9,-25.8).lineTo(1.9,-19.8).lineTo(23.3,-19.8).lineTo(23.3,-15.8).lineTo(1.9,-15.8).lineTo(1.9,-8.6).lineTo(19.1,-8.6).lineTo(19.1,9.3).closePath().moveTo(-14.6,5.3).lineTo(14.8,5.3).lineTo(14.8,-4.7).lineTo(-14.6,-4.7).closePath();
	this.shape_6.setTransform(162.9,49.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#000000").beginStroke().moveTo(-25.2,24.8).lineTo(-25.2,21.3).lineTo(-2.3,21.3).lineTo(-2.3,16.5).lineTo(-21,16.5).lineTo(-21,13).lineTo(-2.3,13).lineTo(-2.3,9.2).lineTo(-19.3,9.2).lineTo(-19.3,-8.3).lineTo(-2.3,-8.3).lineTo(-2.3,-11.7).lineTo(-24.9,-11.7).lineTo(-24.9,-15.1).lineTo(-2.3,-15.1).lineTo(-2.3,-19.3).curveTo(-6.8,-18.9,-11.2,-18.7).lineTo(-19.8,-18.5).curveTo(-19.8,-19.3,-20.1,-20.2).lineTo(-20.7,-21.9).lineTo(-10.5,-22.2).curveTo(-5.3,-22.4,-0.2,-22.9).curveTo(4.9,-23.2,9.3,-23.7).curveTo(13.8,-24.2,17.2,-24.8).lineTo(19.4,-21.5).curveTo(15.8,-20.8,11.3,-20.3).lineTo(1.8,-19.5).lineTo(1.8,-15.1).lineTo(24.9,-15.1).lineTo(24.9,-11.7).lineTo(1.8,-11.7).lineTo(1.8,-8.3).lineTo(19.5,-8.3).lineTo(19.5,9.2).lineTo(1.8,9.2).lineTo(1.8,13).lineTo(21.6,13).lineTo(21.6,16.5).lineTo(1.8,16.5).lineTo(1.8,21.3).lineTo(25.2,21.3).lineTo(25.2,24.8).closePath().moveTo(1.8,6.1).lineTo(15.3,6.1).lineTo(15.3,1.9).lineTo(1.8,1.9).closePath().moveTo(-15.1,6.1).lineTo(-2.3,6.1).lineTo(-2.3,1.9).lineTo(-15.1,1.9).closePath().moveTo(1.8,-1).lineTo(15.3,-1).lineTo(15.3,-5.2).lineTo(1.8,-5.2).closePath().moveTo(-15.1,-1).lineTo(-2.3,-1).lineTo(-2.3,-5.2).lineTo(-15.1,-5.2).closePath();
	this.shape_7.setTransform(106.6,48.7);
...
}).prototype = getMCSymbolPrototype(lib.title, new cjs.Rectangle(0,-53,1768,923), null);
...
(lib.弹框重点下弹力跳音 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(884,474.5,1,1,0,0,0,884,408.5);
	...
	// 形状 1 拷贝 61
	this.instance_3 = new lib.形状1拷贝61_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(884,474.5,1,1,0,0,0,884,461.5);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// 图层_3
	this.instance = new lib.跳音知识点04下弹力();
	this.instance.parent = this;
	this.instance.setTransform(394,176);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(1630.9,800.4,1,1,0,0,0,0,-2);

	this.instance_2 = new lib.弹框重点下弹力跳音();
	this.instance_2.parent = this;
	this.instance_2.setTransform(884,461.5,1,1,0,0,0,884,474.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BGtitle.jpg?1530778750039", id:"BGtitle"},
		{src:"images/04.2下弹力_atlas_P_.png?1530778750001", id:"04.2下弹力_atlas_P_"}
	],
	preloads: []
};
